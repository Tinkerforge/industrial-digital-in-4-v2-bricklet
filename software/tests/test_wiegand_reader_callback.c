...
void cb_wiegand_data(bool *data, uint16_t data_length, void *user_data) {
...
int main(void) {
    ...
    industrial_digital_in_4_v2_register_callback(&idi4,
                                                 INDUSTRIAL_DIGITAL_IN_4_V2_CALLBACK_WIEGAND_DATA,
                                                 (void (*)(void))cb_wiegand_data,
                                                 NULL);
    industrial_digital_in_4_v2_register_callback(&idi4,
    ...
    industrial_digital_in_4_v2_set_wiegand_callback_config(&idi4, true, false, true);
