...
public class TestWiegandCallback {
	...
	public static void main(String args[]) throws Exception {
		...
		idi4.addWiegandDataListener(new BrickletIndustrialDigitalIn4V2.WiegandDataListener() {
			public void wiegandData(boolean[] data) {
		...
		idi4.setWiegandCallbackConfig(true, false, true);
